...
export default function AccountPage() {
  ...
  return (
    <main className="bg-[#fafafa] w-full min-h-screen lg:px-3 pb-[84px] lg:pb-0 flex lg:flex-row flex-col justify-between lg:justify-center lg:items-center">
      
      <div className="w-full h-[600px] lg:h-[500px] flex justify-between">
        <div className="w-[250px] h-[352px] shadow-[0px_1px_2px_0px_#1018280F] rounded-[12px] flex flex-col justify-between">
        ...
        {!isMobile && (
          <div className="min-w-[440px] h-[474px]">
            {renderContent()}
          </div>
        )}
      </div>
